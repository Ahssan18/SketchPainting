...
public class SketchFillActivity  extends AppCompatActivity implements View.OnClickListener {

    private ImageView iv_back, iv_eraser, iv_undo, iv_redo, iv_indicator, iv_delete, iv_share, iv_download;
    MyCanvas myCanvas;
    private SeekBar seekBar;
    private LinearLayout linearRed, linearleaf, linearPink, linearEraser,linearSkyblue,linearBlue,linearBrown,linearPurpule,linearBlack,linearMehron,
            linearOrange,linearYellow;
    public static LinearLayout linearCanvas;
    int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_touch_fill);
        ...
        Toast.makeText(this, "Sketch Fill", Toast.LENGTH_SHORT).show();
    ...
    private void init() {
        ...
        myCanvas = new MyCanvas(this, "sketch_fill", SketchesDataActivity.sketchList.get(position).getImage());
